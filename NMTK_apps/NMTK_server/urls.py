...
urlpatterns = [
    url('^ui/$', views.nmtk_ui,
        {}, name='nmtk_server_nmtk_ui'),
    url('^$', views.nmtk_index,
    ...
    url('^tools/update$',
        ...
        {},
        name='updateStatus'),
    #   url('^submit-job-to-tool$', views.configureJob', {}, name='configureJob'),
    #   url('^refresh-status/(?P<job_id>[^/]*)$', views.refreshStatus', {}, name='refreshStatus'),
    #   url('^results/(?P<job_id>[^/]*)$', views.viewResults', {}, name='viewResults'),
    #   url('^download_results/(?P<job_id>[^/]*)$', views.downloadResults', {}, name='downloadResults'),
    #   url('^downloadDataFile/(?P<file_id>[^/]*)$', views.downloadDataFile', {}, name='NMTK_server.download_datafile'),
    #   url('^downloadGeoJsonFile/(?P<file_id>[^/]*)$', views.downloadGeoJsonFile', {}, name='NMTK_server.download_geojson_datafile'),
